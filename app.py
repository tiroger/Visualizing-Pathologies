...
def main():
    ...
    with st.sidebar.title('About'):
        ...
        <h3>Features</h3>
        <li><b>Image Upload</b>: Users can upload ultrasound images of tumors for analysis.<br></li>
        <li><b>Contour Analysis</b>: The app processes uploaded images to detect and highlight contours of tumors, facilitating visual assessment of size and shape.<br></li>
        <li><b>Sphericity Measurement</b>: By evaluating the roundness of detected contours, the app assists in identifying characteristics typically associated with benign or malignant tumors.<br></li>
        <li><b>Threshold Adjustment</b>: Users can adjust the threshold settings for contour detection and sphericity to fine-tune the analysis based on specific case needs.<br></li>
        <li><b>Deep Learning Prediction</b>: The core of the app lies in its ability to predict whether a tumor is likely benign or malignant, using a trained machine learning model. The prediction is accompanied by a probability score, providing insight into the model's confidence.<br></li>
        <li><b>Interactive Visuals</b>: The application includes interactive heatmaps and contour overlays, allowing for an in-depth examination of the tumor's properties.<br></li>
        The web application is straightforward to use: simply upload an ultrasound image, and the system will automatically process the image, display relevant visual insights, and provide a prediction for the nature of the tumor.<br>
